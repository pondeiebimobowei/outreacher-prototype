...
function Nav() {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 px-5 sm:px-8 bg-white/90 backdrop-blur-md" style={{ borderBottom: '1px solid var(--color-border)' }}>
      <div className="max-w-275 mx-auto flex items-center justify-between h-16">
      ...
      {menuOpen && (
        <div className="md:hidden absolute top-16 left-0 right-0 bg-white border-b shadow-lg p-5 flex flex-col gap-4" style={{ borderColor: 'var(--color-border)' }}>
...
function Hero() {
  ...
  return (
    <section className="pt-32 pb-20 px-5 sm:px-8">
      <div className="max-w-275 mx-auto text-center flex flex-col items-center">
        <h1 className="text-[42px] sm:text-[56px] lg:text-[72px] font-extrabold leading-[1.05] tracking-[-0.03em] max-w-200" style={{ color: 'var(--color-primary)', fontFamily: 'Plus Jakarta Sans, sans-serif' }}>
          Stop applying blindly.<br />Start building relationships.
        </h1>
        <p className="text-[18px] sm:text-[20px] leading-[1.6] mt-6 max-w-170" style={{ color: 'var(--color-muted-fg)' }}>
      ...
      <div className="max-w-225 mx-auto mt-20 rounded-2xl overflow-hidden shadow-xl" style={{ border: '1px solid var(--color-border)', background: 'var(--color-background)' }}>
        ...
        <div className="p-5 sm:p-10 bg-white">
          <div className="flex flex-col gap-6 max-w-150 mx-auto">
            <div className="flex items-center gap-4 pb-4 border-b" style={{ borderColor: 'var(--color-border)' }}>
              ...
              <div>
                <h3 className="text-xl font-bold font-['Plus_Jakarta_Sans'] text-(--color-primary)">Stripe</h3>
            ...
            <div className="flex flex-col gap-3">
              <div className="p-4 rounded-xl border flex items-start gap-4" style={{ borderColor: 'var(--color-border)' }}>
                <div className="w-8 h-8 rounded bg-blue-50 text-blue-600 flex items-center justify-center shrink-0 mt-0.5"><Icon d={icons.search} size={14} /></div>
                <div>
                  ...
                  <p className="font-medium text-[14px] text-(--color-primary)">New developer tooling team expansion</p>
              ...
              <div className="p-4 rounded-xl border flex items-start gap-4" style={{ borderColor: 'var(--color-border)' }}>
                <div className="w-8 h-8 rounded bg-amber-50 text-amber-600 flex items-center justify-center shrink-0 mt-0.5"><Icon d={icons.opportunities} size={14} /></div>
                <div>
              ...
              <div className="p-4 rounded-xl border flex items-start gap-4" style={{ borderColor: 'var(--color-border)' }}>
                <div className="w-8 h-8 rounded bg-purple-50 text-purple-600 flex items-center justify-center shrink-0 mt-0.5"><Icon d={icons.contacts} size={14} /></div>
                <div>
                  <p className="text-[12px] font-bold text-gray-400 uppercase tracking-wider mb-1 font-['Plus_Jakarta_Sans']">Person & Why</p>
                  <p className="font-medium text-[14px] text-(--color-primary)">Alex Chen · Engineering Manager</p>
  ...
  return (
    <section className="py-24 px-5 sm:px-8 border-t bg-white" style={{ borderColor: 'var(--color-border)' }}>
      <div className="max-w-275 mx-auto">
        <div className="text-center max-w-200 mx-auto mb-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
          ...
          <div className="p-8 rounded-2xl border" style={{ borderColor: 'var(--color-border)', background: 'var(--color-background)' }}>
            ...
            <div className="flex flex-col gap-0 relative">
              <div className="absolute left-3.75 top-6 bottom-6 w-px bg-gray-300" />
          ...
          <div className="p-8 rounded-2xl border shadow-sm relative overflow-hidden" style={{ borderColor: 'var(--color-border)', background: 'white' }}>
            ...
            <div className="flex flex-col gap-0 relative">
              <div className="absolute left-3.75 top-6 bottom-6 w-px bg-indigo-100" />
...
function ProductConceptSection() {
  return (
    <section id="product" className="py-24 px-5 sm:px-8 border-t bg-background" style={{ borderColor: 'var(--color-border)' }}>
      <div className="max-w-275 mx-auto">
        <div className="mb-16">
          <h2 className="text-[32px] sm:text-[40px] font-bold tracking-tight mb-4" style={{ color: 'var(--color-primary)', fontFamily: 'Plus Jakarta Sans, sans-serif' }}>
            Know why you're reaching out before you hit send.
          </h2>
          <p className="text-[18px] leading-[1.6] text-muted-fg max-w-175">
      ...
      <div className="max-w-275 mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="p-6 rounded-2xl border bg-gray-50" style={{ borderColor: 'var(--color-border)' }}>
            ...
            <h3 className="text-[18px] font-bold mb-2 text-(--color-primary) font-['Plus_Jakarta_Sans']">A relevant opening exists.</h3>
            <p className="text-[14.5px] leading-[1.6] text-muted-fg">A relevant opening is supported by evidence. The timing is clear — this is the moment to act.</p>
          </div>
          <div className="p-6 rounded-2xl border bg-gray-50" style={{ borderColor: 'var(--color-border)' }}>
            ...
            <h3 className="text-[18px] font-bold mb-2 text-(--color-primary) font-['Plus_Jakarta_Sans']">No opening — but strong signal.</h3>
            <p className="text-[14.5px] leading-[1.6] text-muted-fg">There is no confirmed opening, but there is enough company-fit evidence to justify building a relationship.</p>
          </div>
          <div className="p-6 rounded-2xl border bg-gray-50" style={{ borderColor: 'var(--color-border)' }}>
            ...
            <h3 className="text-[18px] font-bold mb-2 text-(--color-primary) font-['Plus_Jakarta_Sans']">Research still needed.</h3>
            <p className="text-[14.5px] leading-[1.6] text-muted-fg">There is not enough evidence yet to classify this company. Keep researching before reaching out.</p>
          </div>
        </div>
      </div>
    </section>
...
function PersonSection() {
  return (
    <section className="py-24 px-5 sm:px-8 border-t bg-background" style={{ borderColor: 'var(--color-border)' }}>
      <div className="max-w-275 mx-auto flex flex-col lg:flex-row gap-12 items-center">
        <div className="flex-1">
          ...
          <div className="flex flex-col gap-4 mt-8">
            <div className="flex items-center gap-4"><div className="w-10 h-10 rounded-full border bg-white flex items-center justify-center font-bold text-[14px]">1</div><span className="text-[16px] font-medium text-(--color-primary)">Opportunity</span></div>
            <div className="w-0.5 h-6 bg-gray-300 ml-5" />
            <div className="flex items-center gap-4"><div className="w-10 h-10 rounded-full border bg-white flex items-center justify-center font-bold text-[14px]">2</div><span className="text-[16px] font-medium text-(--color-primary)">Relevant person</span></div>
            <div className="w-0.5 h-6 bg-gray-300 ml-5" />
            <div className="flex items-center gap-4"><div className="w-10 h-10 rounded-full border bg-white flex items-center justify-center font-bold text-[14px]">3</div><span className="text-[16px] font-medium text-(--color-primary)">Reason to contact</span></div>
          </div>
        </div>

        <div className="w-full lg:w-120 p-6 rounded-2xl border bg-white shadow-md" style={{ borderColor: 'var(--color-border)' }}>
          <div className="flex items-center gap-4 border-b pb-4 mb-4" style={{ borderColor: 'var(--color-border)' }}>
            ...
            <div>
              <h4 className="text-[16px] font-bold text-(--color-primary) font-['Plus_Jakarta_Sans']">Sarah Davis</h4>
              <p className="text-[13px] text-muted-fg">Design Director · Acme Corp</p>
            </div>
          </div>
          <div className="flex flex-col gap-4 mb-6">
            <div>
              <p className="text-[11px] font-bold text-gray-400 uppercase tracking-wider mb-1">Why this person</p>
              <p className="text-[14px] text-(--color-primary)">Leads the design system team which was recently formed according to their tech blog.</p>
            </div>
            <div>
              <p className="text-[11px] font-bold text-gray-400 uppercase tracking-wider mb-1">Supporting evidence</p>
              <p className="text-[14px] text-(--color-primary)">"We are scaling our component library" (Acme Tech Blog)</p>
            </div>
            <div>
              <p className="text-[11px] font-bold text-gray-400 uppercase tracking-wider mb-1">Conversation angle</p>
              <p className="text-[14px] text-(--color-primary)">Discuss challenges of migrating legacy components to the new system.</p>
            </div>
          </div>
  ...
  return (
    <section className="py-24 px-5 sm:px-8 border-t bg-white" style={{ borderColor: 'var(--color-border)' }}>
      <div className="max-w-275 mx-auto text-center">
        ...
        <p className="text-[18px] leading-[1.6] text-muted-fg max-w-175 mx-auto mb-16">
        ...
        <div className="flex flex-col lg:flex-row justify-center items-stretch gap-6">
          <div className="p-6 rounded-2xl border bg-gray-50 flex-1 text-left" style={{ borderColor: 'var(--color-border)' }}>
            ...
            <div className="flex flex-col gap-2 text-[14px] font-medium text-(--color-primary)">
          ...
          <div className="flex items-center justify-center px-2 text-gray-300">
            ...
            <Icon d={icons.arrowLeft} size={24} className="lg:hidden" />
          </div>
          ...
          <div className="p-6 rounded-2xl border bg-gray-50 flex-1 text-left flex flex-col justify-center" style={{ borderColor: 'var(--color-border)' }}>
            ...
            <div className="flex items-center justify-between text-[14px] font-semibold text-(--color-primary) relative">
...
function ConversationSection() {
  return (
    <section className="py-24 px-5 sm:px-8 border-t bg-background" style={{ borderColor: 'var(--color-border)' }}>
      <div className="max-w-275 mx-auto flex flex-col lg:flex-row gap-16 items-center">
        <div className="flex-1">
          <h2 className="text-[32px] sm:text-[40px] font-bold tracking-tight mb-6" style={{ color: 'var(--color-primary)', fontFamily: 'Plus Jakarta Sans, sans-serif' }}>
            The relationship doesn't end when the email is sent.
          </h2>
          <div className="flex flex-col gap-4 mt-8">
            <div className="flex items-center gap-3 font-medium text-[16px] text-(--color-primary)">Outreach sent <Icon d={icons.arrowRight} size={14} className="text-gray-400" /> Conversation <Icon d={icons.arrowRight} size={14} className="text-gray-400" /> Reply <Icon d={icons.arrowRight} size={14} className="text-gray-400" /> Continue relationship</div>
          </div>
        </div>

        <div className="w-full lg:w-115 rounded-2xl border bg-white shadow-md overflow-hidden" style={{ borderColor: 'var(--color-border)' }}>
          <div className="p-6">
            <div className="flex flex-col gap-6 relative">
              <div className="absolute top-2 bottom-2 left-3.75 w-px bg-gray-200" />

              <div className="flex gap-4 relative z-10">
                <div className="w-8 h-8 rounded-full bg-blue-100 flex items-center justify-center shrink-0 text-blue-600 border border-blue-200"><Icon d={icons.outreach} size={14} /></div>
                <div>
                  <p className="text-[14px] font-bold text-(--color-primary) font-['Plus_Jakarta_Sans']">You sent outreach</p>
              ...
              <div className="flex gap-4 relative z-10">
                <div className="w-8 h-8 rounded-full bg-gray-100 flex items-center justify-center shrink-0 text-gray-500 border border-gray-200"><Icon d={icons.clock} size={14} /></div>
        ...
        <div className="flex flex-col md:flex-row items-stretch justify-center gap-0">
          {steps.map((step, i) => (
            <div key={i} className="flex-1 flex flex-col items-center">
              ...
              <p className="mt-4 text-[14px] font-semibold text-(--color-primary) font-['Plus_Jakarta_Sans'] hidden md:block">{step}</p>

              <div className="md:hidden flex items-center py-4 w-full">
                <p className="text-[15px] font-semibold text-(--color-primary) font-['Plus_Jakarta_Sans'] text-center w-full">{step}</p>
              </div>
...
function UseCasesSection() {
  return (
    <section id="use-cases" className="py-24 px-5 sm:px-8 border-t bg-background" style={{ borderColor: 'var(--color-border)' }}>
      <div className="max-w-275 mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="p-8 rounded-2xl border bg-white shadow-sm" style={{ borderColor: 'var(--color-border)' }}>
            <h3 className="text-[18px] font-bold mb-3 text-(--color-primary) font-['Plus_Jakarta_Sans']">Target-company job seekers</h3>
            <p className="text-[15px] leading-[1.6] text-muted-fg">You know exactly where you want to work, but need a better path in than throwing an application into the ATS void.</p>
          </div>
          <div className="p-8 rounded-2xl border bg-white shadow-sm" style={{ borderColor: 'var(--color-border)' }}>
            <h3 className="text-[18px] font-bold mb-3 text-(--color-primary) font-['Plus_Jakarta_Sans']">Career switchers</h3>
            <p className="text-[15px] leading-[1.6] text-muted-fg">You want to build credibility and relationships by showing you understand their problems, rather than relying entirely on past titles.</p>
          </div>
          <div className="p-8 rounded-2xl border bg-white shadow-sm" style={{ borderColor: 'var(--color-border)' }}>
            <h3 className="text-[18px] font-bold mb-3 text-(--color-primary) font-['Plus_Jakarta_Sans']">Experienced professionals</h3>
            <p className="text-[15px] leading-[1.6] text-muted-fg">You want targeted, peer-level conversations with hiring managers and leaders instead of mass applications.</p>
          </div>
          <div className="p-8 rounded-2xl border bg-white shadow-sm" style={{ borderColor: 'var(--color-border)' }}>
            <h3 className="text-[18px] font-bold mb-3 text-(--color-primary) font-['Plus_Jakarta_Sans']">Intentional networkers</h3>
            <p className="text-[15px] leading-[1.6] text-muted-fg">You want every message you send to have a real reason, solid context, and actual value behind it.</p>
          </div>
        </div>
      </div>
    </section>
    ...
    <section className="py-24 px-5 sm:px-8 border-t bg-white" style={{ borderColor: 'var(--color-border)' }}>
      <div className="max-w-200 mx-auto">
        ...
        <div className="flex flex-col gap-4">
          {faqs.map((faq, i) => (
            <details key={i} className="group rounded-2xl border bg-background open:bg-white transition-colors" style={{ borderColor: 'var(--color-border)' }}>
              <summary className="flex items-center justify-between p-6 cursor-pointer font-bold text-[16px] text-(--color-primary) font-['Plus_Jakarta_Sans'] list-none">
                {faq.q}
                <span className="group-open:rotate-90 transition-transform"><Icon d={icons.arrowRight} size={20} /></span>
              </summary>
              <div className="px-6 pb-6 text-[15px] leading-[1.6] text-muted-fg">
                {faq.a}
              </div>
            </details>
          ))}
...
function FinalCTA() {
  const navigate = useNavigate()
  return (
    <section className="py-32 px-5 sm:px-8 border-t bg-background" style={{ borderColor: 'var(--color-border)' }}>
      <div className="max-w-200 mx-auto text-center">
        ...
        <p className="text-[18px] sm:text-[20px] leading-[1.6] mb-10 text-muted-fg">
...
function Footer() {
  ...
  return (
    <footer className="py-10 px-5 sm:px-8 border-t bg-white" style={{ borderColor: 'var(--color-border)' }}>
      <div className="max-w-275 mx-auto flex flex-col md:flex-row justify-between items-start md:items-center gap-8">
        <div className="flex flex-col gap-4">
        ...
        <div className="flex flex-wrap items-center gap-4 sm:gap-6">
          <button onClick={() => handleScroll('product')} className="text-[13.5px] text-muted-fg hover:text-(--color-primary) transition-colors">Product</button>
          <button onClick={() => handleScroll('how-it-works')} className="text-[13.5px] text-muted-fg hover:text-(--color-primary) transition-colors">How it works</button>
          <button onClick={() => handleScroll('use-cases')} className="text-[13.5px] text-muted-fg hover:text-(--color-primary) transition-colors">Use cases</button>
          <button onClick={() => navigate('/login')} className="text-[13.5px] text-muted-fg hover:text-(--color-primary) transition-colors">Sign in</button>
        </div>
      </div>
    </footer>
  )
